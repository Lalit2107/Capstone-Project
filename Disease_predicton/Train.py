...
# Load the dataset (using your split dataset)
train_data = datasets.ImageFolder(root=r"D:/Dataset_split/train", transform=transform)
val_data = datasets.ImageFolder(root=r"D:/Dataset_split/val", transform=transform)
test_data = datasets.ImageFolder(root=r"D:/Dataset_split/test", transform=transform)
